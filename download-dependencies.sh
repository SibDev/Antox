...
mkdir -p app/src/main/jniLibs/{armeabi,x86,arm64-v8a}

rm app/src/main/jniLibs/{armeabi,x86,arm64-v8a}/libtox4j.so
...
rm app/src/main/jniLibs/{armeabi,x86,arm64-v8a}/libkaliumjni.so
